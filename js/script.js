...
card1.addEventListener('mouseover', () => {
    ...
    card1img.style.width = '380px';
    card1img.style.height = '220px';
...
card2.addEventListener('mouseover', () => {
    ...
    card2img.style.width = '380px';
    card2img.style.height = '220px';
...
card3.addEventListener('mouseover', () => {
    ...
    card3img.style.width = '380px';
    card3img.style.height = '220px';
...
card4.addEventListener('mouseover', () => {
    ...
    card4img.style.width = '380px';
    card4img.style.height = '220px';
